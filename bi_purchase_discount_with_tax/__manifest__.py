...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
    ...
    'price': 29,
    'currency': "EUR",
    'summary': 'purchase discount purchase order discount invoice discount with tax amount global discount invoice fixed discount with tax calculation discount on vendor bill discount with tax vendor discount on invoice All in one Discount purchase discount with tax',
    'description': """
...
""",
    ...
    'auto_install': False,
    'application': True,
    'live_test_url': "https://youtu.be/sdJHdP7zeDE",
