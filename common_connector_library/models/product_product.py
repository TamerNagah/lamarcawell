...
class ProductProduct(models.Model):
    ...
    nombre_image_ultimo = fields.Char(string="name image", required=False, )
    ...
    def prepare_common_image_vals(self, vals):
        ...
        image_vals = {"sequence":0,
                      ...
                      "image_name":vals.get("nombre_image_ultimo", False)}
        return image_vals
    ...
    def write(self, vals):
        ...
        if vals.get("image_1920", False) and self :
            imagen_woo=self.env['common.product.image.ept'].search([('image_name', '=',  vals['nombre_image_ultimo'])])
            if imagen_woo:
                return res
            else:
