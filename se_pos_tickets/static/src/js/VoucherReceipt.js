odoo.define('se_pos_tickets.VoucherReceipt', function(require) {
    'use strict';

    const PosComponent = require('point_of_sale.PosComponent');
    const Registries = require('point_of_sale.Registries');

    class VoucherReceipt extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    VoucherReceipt.template = 'VoucherReceipt';

    Registries.Component.add(VoucherReceipt);
